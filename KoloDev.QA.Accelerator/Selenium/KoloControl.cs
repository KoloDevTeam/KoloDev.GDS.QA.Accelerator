            ...
            try
            {
                ...
                foreach (var session in sessions)
                {
                    try
                    {
                        ...
                        string seleniumurl = session.AutomationSession.Logs.ToString();
                        ...
                        await seleniumurl.WithBasicAuth(username, password).DownloadFileAsync("TestResults/", filename + "_Logs.json");
